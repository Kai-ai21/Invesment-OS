  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="-mt-0.5 -mr-1 shrink-0 rounded-lg p-1 text-text-muted transition-colors hover:text-text-primary focus-visible:ring-3 focus-visible:ring-ring/50 focus-visible:outline-none"
      >
